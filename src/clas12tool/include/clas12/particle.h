...
namespace clas12 {
  ...
  public:
    ...
    void getVector3(int index, vector3& vect) {
      vect.setXYZ(getFloat(px_order, index), getFloat(py_order, index), getFloat(pz_order, index));
    }

    void getVector4(int index, vector4& vect, double mass) {
      vect.setXYZM(getFloat(px_order, index), getFloat(py_order, index), getFloat(pz_order, index),
                   mass);
    }
    /**
